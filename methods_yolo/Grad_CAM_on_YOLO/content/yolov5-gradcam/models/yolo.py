...
class Model(nn.Module):
    def __init__(self, cfg=r'C:\Users\Lenovo\PycharmProjects\pythonProject1\content\yolov5-gradcam\models\yolov5s.yaml', ch=3, nc=3, anchors=None):  # model, input channels, number of classes
        super().__init__()
